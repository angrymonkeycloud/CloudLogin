...
public static class DemoFeatureCatalog
{
    ...
    [
        ...
        new("Organizations", "Business identity", "Create businesses, assign owners, add team members, attach roles and permissions, and issue invitations.", "/organizations", "Interactive", ["Owners", "Members", "Roles", "Permissions", "Invitations"]),
        new("Subscriptions", "Account registry", "Register application-owned subscriptions for a user or organization and execute real active-state queries.", "/subscriptions", "Interactive", ["Status", "Expiry", "Auto-renew", "Provider refs", "Metadata"]),
